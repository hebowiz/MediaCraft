...
- 音声ファイルのジャケット画像、タイトル、Artist、Album、Codec、Bitrate表示
...
- フレーム番号、FPS／VFR判定、動画・音声Codec、ミリ秒単位の時刻表示
...
Artist、Album、Codec、Bitrateを表示します。CodecとBitrateは横並びです。ジャケット画像がない場合は画像領域を
